...
\geometry{left=1.0cm, top=0cm, right=1.0cm, bottom=1.0cm}%, footskip=.5cm}
...
\name{R. Frederic}{Sauve-Hoover}
%\position{Software Developer}
\address{9723 88 Ave NW, Edmonton AB, T6E 2R1}

\mobile{+1 (780) 966-4114}
\email{rsauveho@ualberta.ca}
% \homepage{homepage}
\github{rsauvehoover}
\linkedin{rsauvehoover}
% \gitlab{gitlab-id}
